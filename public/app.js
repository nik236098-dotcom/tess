...
const SEAT_ANCHORS = [
  // Координаты подобраны оптимизатором по реальной границе сукна, снятой
  // с ассета, и проверены на наборах мест для 4, 6 и 8 игроков сразу.
  // Ограничения: блок внутри сукна, блок ↔ борд, блок ↔ банк, блок ↔ блок,
  // ставка внутри сукна, ставка ↔ борд/банк/блок/ставка, и ставка не дальше
  // 115 px от своего места, чтобы она читалась как его.
  // Ставка героя стоит НАД банком: под банком лежат его карты, а сам банк
  // сдвинуть нельзя — на ассете под ним нарисована плашка.
  { seat: [0.4972, 0.8273], bet: [0.4975, 0.5750], shift: [0, -14] },   // низ по центру (герой)
  { seat: [0.2597, 0.7486], bet: [0.3315, 0.6522], shift: [22, -24] },  // низ слева
  { seat: [0.1989, 0.4834], bet: [0.3150, 0.5529], shift: [1, 0] },     // середина слева
  { seat: [0.2652, 0.2348], bet: [0.3865, 0.3824], shift: [10, 0] },    // верх слева
  { seat: [0.4972, 0.1561], bet: [0.4982, 0.3028], shift: [0, 0] },     // верх по центру
  { seat: [0.7348, 0.2348], bet: [0.6135, 0.3824], shift: [-10, 0] },   // верх справа
  { seat: [0.7956, 0.4834], bet: [0.6681, 0.5522], shift: [-6, 0] },    // середина справа
  { seat: [0.7348, 0.7486], bet: [0.6685, 0.6522], shift: [-22, -24] }, // низ справа
];

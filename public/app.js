...
const BET_BY_COUNT = {
  ...
  5: { 0: [0.4976, 0.5750], 2: [0.3116, 0.5750], 3: [0.3584, 0.3409], 5: [0.6416, 0.3409], 6: [0.6884, 0.5750] },
  6: { 0: [0.4976, 0.5750], 2: [0.3116, 0.5750], 3: [0.3584, 0.3409], 4: [0.4976, 0.2937], 5: [0.6416, 0.3409], 6: [0.6884, 0.5750] },
...
function seatAnchor(index, count) {
  ...
  if (set) {
    ...
    return { ...SEAT_ANCHORS[at], bet: bets[at] || [0.4976, 0.5750], at };
  }

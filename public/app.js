...
const LAYOUTS = {
  2: {
    ...
    shift: { 4: [0, 0] },
    bet: { 0: [0.4976, 0.575], 4: [0.4985, 0.3494] },
  },
  3: {
    seats: [0, 3, 5],
    bodyW: 84, avatar: 44, cardW: 23,
    shift: { 3: [32, 0], 5: [-32, 0] },
    bet: { 0: [0.4976, 0.575], 3: [0.4335, 0.4288], 5: [0.5665, 0.4288] },
  },
  4: {
    seats: [0, 3, 4, 5],
    bodyW: 84, avatar: 44, cardW: 23,
    shift: { 3: [4, 26], 4: [0, 0], 5: [-4, 26] },
    bet: { 0: [0.4976, 0.575], 3: [0.4367, 0.4362], 4: [0.4985, 0.3494], 5: [0.5633, 0.4362] },
  },
  5: {
    seats: [0, 1, 3, 5, 7],
    bodyW: 60, avatar: 40, cardW: 21,
    shift: { 1: [26, -36], 3: [4, 18], 5: [-4, 18], 7: [-26, -36] },
    bet: { 0: [0.4976, 0.575], 1: [0.3238, 0.6299], 3: [0.4061, 0.423], 5: [0.5939, 0.423], 7: [0.6762, 0.6299] },
  },
  6: {
    seats: [0, 1, 3, 4, 5, 7],
    bodyW: 60, avatar: 40, cardW: 21,
    shift: { 1: [26, -36], 3: [4, 18], 4: [0, 0], 5: [-4, 18], 7: [-26, -36] },
    bet: { 0: [0.4976, 0.575], 1: [0.3238, 0.6299], 3: [0.4061, 0.423], 4: [0.4983, 0.3178], 5: [0.5939, 0.423], 7: [0.6762, 0.6299] },
  },
  7: {
    seats: [0, 1, 2, 3, 5, 6, 7],
    bodyW: 42, avatar: 40, cardW: 19,
    shift: { 1: [22, -24], 2: [6, 0], 3: [10, 0], 5: [-10, 0], 6: [-6, 0], 7: [-22, -24] },
    bet: { 0: [0.4976, 0.575], 1: [0.3348, 0.6479], 2: [0.3338, 0.5568], 3: [0.3865, 0.3824], 5: [0.6135, 0.3824], 6: [0.6662, 0.5568], 7: [0.6652, 0.6479] },
  },
  8: {
    seats: [0, 1, 2, 3, 4, 5, 6, 7],
    bodyW: 42, avatar: 40, cardW: 19,
    shift: { 1: [22, -24], 2: [6, 0], 3: [10, 0], 4: [0, 0], 5: [-10, 0], 6: [-6, 0], 7: [-22, -24] },
    bet: { 0: [0.4976, 0.575], 1: [0.3348, 0.6479], 2: [0.3338, 0.5568], 3: [0.3865, 0.3824], 4: [0.4982, 0.3078], 5: [0.6135, 0.3824], 6: [0.6662, 0.5568], 7: [0.6652, 0.6479] },
  },
};

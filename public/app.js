...
const SEAT_LAYOUT = [
  // Место — один блок: АВАТАР + КАРТЫ + ПЛАШКА. Карты стоят вплотную сбоку
  // от аватара на внутренней стороне, слегка заходя за него, и не залезают
  // на плашку. Смещение = радиус аватара (21.5) + половина пары карт (19)
  // − нахлёст (5). К банку уходит только ставка.
  { cards: [0, -70], bet: [76, -16] },    // 0 герой: фишки справа, между ним и банком
  { cards: [35, -6], bet: [44, -46] },    // 1 низ слева: фишки выше карт
  { cards: [35, -4], bet: [58, 6] },      // 2 середина слева
  { cards: [34, 0], bet: [50, 34] },      // 3 верх слева
  { cards: [0, 16], bet: [0, 64] },       // 4 верх по центру: карты под аватаром
  { cards: [-34, 0], bet: [-50, 34] },    // 5 верх справа
  { cards: [-35, -4], bet: [-58, 6] },    // 6 середина справа
  { cards: [-35, -6], bet: [-44, -46] },  // 7 низ справа: фишки выше карт
];

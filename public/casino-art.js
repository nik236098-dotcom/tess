...
const CasinoArt=(()=>{
 ...
 function cover(id){
  ...
  const map={diamonds:'gem',limbo:'orbit',chicken:'chicken',coin:'coin',penalty:'ball',darts:'target',bowling:'bowling',balloon:'balloon',race:'race',pinball:'pinball',fishing:'fish'};

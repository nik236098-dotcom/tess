'use strict';
const CasinoArt=(()=>{
 const cells={gem:0,chicken:1,coin:2,ball:3,rock:4,paper:5,scissors:6,pin:7,race:8,balloon:9,target:10,fish:11,seven:13,bowling:14,orbit:15};
 ...
 function cover(id){
  ...
  const map={diamonds:'gem',chicken:'chicken',coin:'coin',darts:'target',bowling:'bowling',balloon:'balloon',race:'race',fishing:'fish'};

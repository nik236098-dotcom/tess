...
(function(root){
 ...
 const midnight=make('midnight','MIDNIGHT EXPRESS','VAULT HEIST',['Pocket Watch','Leather Case','Rail Lantern','Silver Key','Sealed Letter','Venetian Mask','Velvet Jewel Box','Vault','Conductor','Golden Ticket']);
